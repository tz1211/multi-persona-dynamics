...
def main(vector_dir, layer, vector_type="response_avg_diff", output_dir="output/vector_analysis", analyze_all_layers_flag=False):
    ...
    # Define traits
    traits = ["anxious", "confident", "critical", "humorous", "optimistic", "pessimistic", "sycophantic"]
...
if __name__ == "__main__":
    ...
    parser.add_argument("--vector_dir", type=str, default="output/persona_vectors/Qwen/Qwen3-4B-Instruct-2507",
    ...
    parser.add_argument("--output_dir", type=str, default="figs/vector_geometry",
